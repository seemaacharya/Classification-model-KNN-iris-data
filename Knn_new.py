...
train,test = train_test_split(iris,test_size = 0.2,random_state=0) # 0.2 => 20 percent of entire data 
...
#how to choose a correct k value using elbow method(which gives very good accuracy)
